...
<div class="container" style="text-align: center;">
    <h2><fmt:message key="register.reg"/> </h2>
    <div class="row justify-content-center">
        <div class="col-5 login-content">
            <form class="form" action="${pageContext.request.contextPath}/Controller?action=register_user"
                  method="post">
                ...
                <input class="login-input login-button" type="submit" value="<fmt:message key="register.doReg"/>"><br>
                <p class="errors">
