...
public class ProxyConnection implements Connection {
    ...
    public void close() throws SQLException {
        ...
        try {
            ...
            Util.lOGGER.info("put a connection back");
        } catch (InterruptedException e) {
            Util.lOGGER.error("thread " + Thread.currentThread().getId()
                    + "was interrapted during putting the connection in the connection pull");
        }
    }
